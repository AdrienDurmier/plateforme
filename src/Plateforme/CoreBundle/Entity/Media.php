 ...
 * @ORM\Entity(repositoryClass="Plateforme\CoreBundle\Repository\MediaRepository")
...
abstract class Media {
  ...
  public function preUpload() {
    ...
    $this->url = $this->getUploadRootDir() . "/" . $this->file->guessExtension();
  ...
  public function upload() {
    ...
    $this->file->move(
        ...
        $name   // Le nom du fichier à créer, ici « id.extension »
    );
  }
